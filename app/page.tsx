...
import { ArrowRight, Bot, TrendingUp, BarChart3, Shield, CheckCircle2 } from "lucide-react";
...
export default function HomePage() {
  return (
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden border-b border-gray-200 bg-gradient-to-br from-white via-blue-50/30 to-white py-20 md:py-28">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            {/* Badge */}
            <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-blue-50 px-4 py-2 text-sm font-semibold text-blue-700 border border-blue-100">
            ...
            <p className="mb-4 text-xl text-gray-600 md:text-2xl font-medium">
            ...
            <div className="mb-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Button asChild size="lg" className="btn-premium h-12 px-8 text-base font-semibold bg-blue-600 text-white hover:bg-blue-700">
                <Link href="/auto-trade">
                  Start Generating Returns Now
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="h-12 px-8 text-base font-semibold border-gray-300 hover:bg-gray-50">
      ...
      {/* Algorithm Showcase */}
      <section id="algorithms" className="border-b border-gray-200 bg-white py-20 md:py-28">
        <div className="container mx-auto px-4">
          <AlgorithmShowcase />
        </div>
      </section>
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-700 py-20 text-white">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 p-12 text-center">
            ...
            <Button asChild size="lg" className="btn-premium h-12 px-10 text-base font-semibold bg-white text-blue-600 hover:bg-gray-50">
              <Link href="/pricing">
                Start Trading Now
                <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
